...
setwd("C:/Users/danie/Dropbox/Learning/UC/2023/Semester-2/ITP internship/Repo2/ITPD-data-project/")
recreg <- read.csv("data/wholeRECdatabase_20230816_no_dups.csv", stringsAsFactors = FALSE)
